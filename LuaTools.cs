...
public class LuaTools
{
    ...
    public class LexState : ICloneable
    {
        ...
        private void ReadString(ref Token token, int del)
        {
            ...
            while (current != del)
            {
                ...
                {
                    LuaTools.ThrowError("unfinished string");
                    break;
                }
    ...
    private static void AssignValue(LexState ls, ref object obj, Type type, ref int index, object keyNameObj)
    {
        ...
        if (type != null && type.IsGenericType)
        {
            ...
            else if (obj is IList)
            {
                ...
                {
                    LuaToolsThrowError("wrong file type from list : "+fieldType?.Name+" "+ls.Dump());
                    return;
                }
                var val = ParseExp(ls, fieldType);
    ...
    {
        return LuaTools.settings != null && LuaTools.settings.StrictMode;
    }
    ...
    */
    ...
    public static object FromLua(string code, Type type, Settings settings=null)
    {
        ...
        {
            Debug.LogFormat("LuaTools[parse lua code error] :{0}", cur_ls_in_parse_for_debug.Dump());
            throw;
        }
        return ret;
    }
