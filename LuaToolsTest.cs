...
namespace Tests
{
    public class LuaToolsTest
    {
        ...
        public void TestFromLuaString()
        {
            ...
            Debug.LogFormat("LuaToolsTest[191:04] str:{0}", str);
            obj = LuaUtility.FromLua<TestLuaString>(str);
            Assert.IsNotNull(obj);
        ...
        public void TestFromLuaPolymorphic() 
        {
            ...
            Debug.LogFormat("LuaToolsTest[574:49] test_code:{0}", test_code);
            // LuaUtility.IsShowLog = true;
        ...
        public void TestMultiLineStr()
        {
            ...
            Debug.LogFormat("LuaToolsTest[604:50] code:{0}", code);
        ...
        public void TestToLuaStaticArray()
        {
            ...
            var code = LuaUtility.ToLua(obj);
            Debug.LogFormat("LuaToolsTest[604:50 TestToLuaStaticArray] code:{0}", code);
            for (int i = 0; i < obj.ds.Length; i++)
            {
